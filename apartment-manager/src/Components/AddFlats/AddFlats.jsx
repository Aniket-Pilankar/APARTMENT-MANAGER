...
const AddFlats = () => {
  ...
  const getAllResident = () => {
    axios.get(`https://appartment-manager-backend.onrender.com/resident`).then(({ data }) => {
  ...
  const addFlats_handleOn_submit = (e) => {
    ...
    // console.log('addFlatData:', addFlatData)
    axios.post(`https://appartment-manager-backend.onrender.com/flat`, addFlatData).then(() => {
